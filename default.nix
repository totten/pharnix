/**
 * pharPackage - A very small function download a PHAR executable and 
 ...
 * Usage: 
 *   let
 *     pharPackage = pkgs.callPackage (pkgs.fetchFromGitHub {owner="totten"; repo="phar-nix"; rev="0.1.0";}) {};
 *     box = pharPackage {
 *       name = "box";
